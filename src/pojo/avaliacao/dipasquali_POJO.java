 ...
 * @author guilh
 */
public class dipasquali_POJO {
    int id_dipasquali,id_avaliacao;
    double peso_magro, peso_gordura, peso_ideal, peso_perder, gordura_desejavel, peso_magro_desejavel, peso_gordura_perder, peso_magro_ganhar,IMC; 
    ...
    public int getId_dipasquali() {
        return id_dipasquali;
    }

    public void setId_dipasquali(int id_dipasquali) {
        this.id_dipasquali = id_dipasquali;
    }
