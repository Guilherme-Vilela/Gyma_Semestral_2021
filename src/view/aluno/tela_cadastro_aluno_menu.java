...
import semestral.view.aluno.tela_cadastro_aluno_menu;
 ...
 * @author guilh
 */
public class tela_cadastro_aluno_menu extends javax.swing.JInternalFrame {
    ...
    JInternalFrame tela;
    Dimension dimensao ; 
    public tela_cadastro_aluno_menu(Dimension tamanho,JDesktopPane area_menu_,JDesktopPane area_trabalho_, JInternalFrame aba) {
        initComponents();
...
//        ImageIcon icon = new ImageIcon("src/semestral/imagem/menu/Menu Lateral Perfil Light.png");
...
//        L_imagem.setIcon(icon);
    ...
    private void initComponents() {
        ...
        B_aluno.setBounds(10, 120, 80, 30);
        ...
        B_perfil.setBounds(10, 170, 100, 30);
        ...
        B_anamnese.setBounds(20, 220, 110, 30);
        ...
        B_termo.setBounds(20, 270, 80, 30);
        ...
        B_treino.setBounds(20, 320, 90, 30);
        ...
        B_avalicao.setBounds(30, 370, 90, 30);

        L_imagem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/semestral/imagem/menu/Menu Perfil Light.png"))); // NOI18N
