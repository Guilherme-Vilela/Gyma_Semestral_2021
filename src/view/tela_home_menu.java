 ...
 * @author guilh
 */
public class tela_home_menu extends javax.swing.JInternalFrame {
    ...
    JInternalFrame tela;
    Dimension dimensao ; 
    public tela_home_menu(Dimension tamanho,JDesktopPane area_menu_,JDesktopPane area_trabalho_, JInternalFrame aba) {
        initComponents();
    ...
    public void ajustar_imagem(){
        ...
        ImageIcon icon = new ImageIcon("src/semestral/imagem/menu/Home_Light.png");
...
//        System.out.println("passei por aqui");
    ...
    private void initComponents() {
        ...
        B_avalicao.setBounds(10, 210, 120, 40);
        ...
        B_aluno.setBounds(10, 110, 120, 40);

        L_imagem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/semestral/imagem/menu/Menu Home Light.png"))); // NOI18N
    ...
    private void B_alunoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_B_alunoMouseClicked
        tela_aluno tela_ = new tela_aluno(area_trabalho.getSize(),area_menu, area_trabalho,this); // revisar
        tela_aluno_menu menu_= new tela_aluno_menu(dimensao, area_menu, area_trabalho, tela_);
        tela_= new  tela_aluno(area_trabalho.getSize(),area_menu, area_trabalho,menu_);
